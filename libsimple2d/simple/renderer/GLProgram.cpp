...
{
    Mat4 projection;
    Mat4::createOrthographic(0, 800, 0, 600, -1024, 1024, &projection);

    auto& matrixP = projection;//Matrix::getInstance()->getMatrix(MATRIX_STACK_TYPE::MATRIX_STACK_PROJECTION);
